...
scoreboard objectives add pems_cu_minecraft_aviate_one_km dummy "Aviate one km"

scoreboard objectives add pems_calc_cu_minecraft_boat_one_m minecraft.custom:minecraft.boat_one_cm "Boat one m PEMS Calc"
scoreboard objectives add pems_cu_minecraft_boat_one_m dummy "Boat one m"
scoreboard objectives add pems_calc_cu_minecraft_boat_one_km minecraft.custom:minecraft.boat_one_cm "Boat one km PEMS Calc"
scoreboard objectives add pems_cu_minecraft_boat_one_km dummy "Boat one km"
...
scoreboard objectives add pems_calc_cu_minecraft_walk_under_water_one_m minecraft.custom:minecraft.walk_under_water_one_cm "Walk Under Water one m PEMS Calc"
scoreboard objectives add pems_cu_minecraft_walk_under_water_one_m dummy "Walk Under Water one m"
scoreboard objectives add pems_calc_cu_minecraft_walk_under_water_one_km minecraft.custom:minecraft.walk_under_water_one_cm "Walk Under Water one km PEMS Calc"
